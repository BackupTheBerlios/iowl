...
<ul>
  <li>The computer iOwl is running on must be connected to the Internet (having a valid
      IP-Address). Attention dial up users, iOwl.net try to connect to the Internet at startup.
  <li>Best recommendation results depend on the amount of owl that are actively running.
      The more owls are available on the net the better results are.
  <li>Only html documents can be found, no .pdf or .doc</li>
</ul>

<p>&nbsp;</p>
<p>If you like to keep informed about updates please join the iOwl.net
   <a href="http://lists.berlios.de/mailman/listinfo/iowl-users">mailing list</a>.</p>
